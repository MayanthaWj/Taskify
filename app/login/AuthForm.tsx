      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-white/10 bg-white/4 px-4 py-3 text-sm text-white 
                        placeholder:text-primary-200 focus:outline-none focus:ring-2 focus:ring-primary-500"
          />
        ...
        <div>
          ...
          <input
            ...
            type="password"
            placeholder="••••••••"
            className="w-full rounded-lg border border-white/10 bg-white/4 px-4 py-3 text-sm text-white placeholder:text-primary-200 
        ...
        <div className="mt-2">
          <button
            ...
            className="w-full px-4 py-3 text-sm font-medium text-primary-200 hover:text-white bg-white/5 
                      hover:bg-white/10 rounded-lg border border-white/10 transition-all"
          >
            {loading ? (
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-primary-200">
              ...
              <button 
                type="button" 
                onClick={toggleMode} 
                className="font-semibold text-white hover:text-primary-300 underline underline-offset-2 transition-colors">
